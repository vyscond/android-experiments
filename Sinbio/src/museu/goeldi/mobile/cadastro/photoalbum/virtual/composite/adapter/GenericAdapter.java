package museu.goeldi.mobile.cadastro.photoalbum.virtual.composite.adapter;

import java.util.ArrayList;

import museu.goeldi.mobile.cadastro.photoalbum.virtual.composite.pojo.GenericItemList;
...
public class GenericAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		GenericItemList item = this.items.get ( position );
        
        LayoutInflater inflater = (LayoutInflater) context.getSystemService ( Context.LAYOUT_INFLATER_SERVICE );
        
        View view = inflater.inflate ( item.getLayout ( ) , null );
        
        item.initializeWidgets ( view );
