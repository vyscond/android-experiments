...
public class RegistroAmostra {
	...
	public String toXML(){
		...
		Element protocolo = new Element("protocolo") ;

		protocolo.appendChild(this.protocolo);
		
		/* ----------------------------------------- */
		
		Element atrativo= new Element("atrativo") ;
		
		atrativo.appendChild(this.atrativo);
		
		/* ----------------------------------------- */

		Element data_da_coleta = new Element("data_da_coleta") ;

		data_da_coleta.appendChild(this.data_da_coleta);
		
		/* ----------------------------------------- */
		
		Element hora_da_coleta = new Element("hora_da_coleta") ;
		
		hora_da_coleta.appendChild(this.hora_da_coleta);
		
		/* ----------------------------------------- */
		
		root.appendChild(id_amostra);
		
		root.appendChild(expedicao);
		
		root.appendChild(projeto);
		
		root.appendChild(protocolo);
		
		root.appendChild(atrativo);
		
		root.appendChild(data_da_coleta);
		
		root.appendChild(hora_da_coleta);
